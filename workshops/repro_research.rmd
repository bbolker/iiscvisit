...
```
demog_mort_glmer.html: demog_mort_glmer.rmd demog_funs.R demog_batch_funs.R demog.mort.18apr.RData demog_mort_glmer_batch.RData make.png geom-linerangeh.R
	Rscript -e "library('rmarkdown'); render('demog_mort_glmer.rmd')"

demog_mort_glmer_batch.RData: demog_mort_glmer_batch.R demog_batch_funs.R demog.mort.18apr.RData
	R CMD BATCH --vanilla demog_mort_glmer_batch.R
```
