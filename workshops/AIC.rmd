...
* $\underbrace{-2L}_{\textrm{badness of fit}}+\underbrace{2k}_{\textrm{complexity penalty}}$
* minimize expected difference
* asymptotically equivalent to *leave-one-out cross-validation*2
...
* simple
* handles non-nested models (but see @ripley_selecting_2004)
* accounts for model complexity

## AIC goals

* AIC is for *prediction*
* is it OK to use it to test hypotheses?

## ICs

* distinction among ICs
    * AIC
	* DIC: [@spiegelhalter_bayesian_2002]: prediction for Bayesian multilevel models
	* BIC: identify true model [@yang_can_2005]
	* AICc: finite-sample correction [@richards_testing_2005; @fletcher_model-averaged_2011]
	* QAIC: correct for overdispersion
	* CAIC (conditional) (also DIC): multilevel predictions [@vaida_conditional_2005; @ohara_focus_2007]
